...
<html>
  ...
  <a href="../member/add-member.action" >添加会员</a>
  
  <a href="../user/totest.action" >form提交2个对象</a>
  
  <a href="../exc/index.action" >异常测试</a>
  
  <a href="../token/index.action" >异常安全token</a>
  
  <a href="../jms/test.action" >试试JMS吧</a>
